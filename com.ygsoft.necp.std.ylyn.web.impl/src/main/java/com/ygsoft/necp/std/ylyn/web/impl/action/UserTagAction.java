...
import com.ygsoft.necp.std.ylyn.web.service.action.IUserTagAction;
 ...
 */
@Component
public class UserTagAction extends AbstractBusinessAction<UserTag> implements IUserTagAction {
	
	/**
	 * UserTagAction constructor.
	 * @param newBo newBo.
	 */
	public UserTagAction(UserTag newBo) {
		super(newBo);
	}
