...
import com.ygsoft.necp.std.ylyn.web.service.service.IPostMessageQueryService;
import com.ygsoft.necp.std.ylyn.web.service.context.IPostMessageContext;

/**
 * PostMessageQueryService查询服务类.<br>
 *
 ...
 */
@RestController
@RequestMapping("/necp/mapp/ylyn/query/postMessage")
public class PostMessageQueryService extends GenEntityQueryService<PostMessage, IPostMessageContext>
		implements IPostMessageQueryService {
