...
import com.ygsoft.necp.std.ylyn.web.service.service.IConcernUserQueryService;
import com.ygsoft.necp.std.ylyn.web.service.context.IConcernUserContext;

/**
 * ConcernUserQueryService查询服务类.<br>
 *
 ...
 */
@RestController
@RequestMapping("/necp/mapp/ylyn/query/concernUser")
public class ConcernUserQueryService extends GenEntityQueryService<ConcernUser, IConcernUserContext>
		implements IConcernUserQueryService {
