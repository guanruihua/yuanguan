...
import com.ygsoft.necp.std.ylyn.web.service.service.IPostMessageService;
import com.ygsoft.necp.std.ylyn.web.service.context.IPostMessageContext;

/**
 * PostMessageService服务类.<br>
 *
 ...
 */
@RestController
@RequestMapping("/necp/mapp/ylyn/service/postMessage")
public class PostMessageService extends GenEntityService<PostMessage, IPostMessageContext>
