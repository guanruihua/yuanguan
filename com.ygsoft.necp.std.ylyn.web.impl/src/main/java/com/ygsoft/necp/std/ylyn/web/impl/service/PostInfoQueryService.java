...
import com.ygsoft.necp.std.ylyn.web.service.service.IPostInfoQueryService;
import com.ygsoft.necp.std.ylyn.web.service.context.IPostInfoContext;

/**
 * PostInfoQueryService查询服务类.<br>
 *
 ...
 */
@RestController
@RequestMapping("/necp/mapp/ylyn/query/postInfo")
public class PostInfoQueryService extends GenEntityQueryService<PostInfo, IPostInfoContext>
		implements IPostInfoQueryService {
