...
import com.ygsoft.necp.std.ylyn.web.service.service.ITagKQueryService;
import com.ygsoft.necp.std.ylyn.web.service.context.ITagKContext;

/**
 * TagKQueryService查询服务类.<br>
 *
 ...
 */
@RestController
@RequestMapping("/necp/mapp/ylyn/query/tagK")
public class TagKQueryService extends GenEntityQueryService<TagK, ITagKContext>
		implements ITagKQueryService {
