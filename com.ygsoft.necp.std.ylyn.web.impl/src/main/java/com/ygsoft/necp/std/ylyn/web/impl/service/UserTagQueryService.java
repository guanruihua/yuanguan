...
import com.ygsoft.necp.std.ylyn.web.service.service.IUserTagQueryService;
import com.ygsoft.necp.std.ylyn.web.service.context.IUserTagContext;

/**
 * UserTagQueryService查询服务类.<br>
 *
 ...
 */
@RestController
@RequestMapping("/necp/mapp/ylyn/query/userTag")
public class UserTagQueryService extends GenEntityQueryService<UserTag, IUserTagContext>
		implements IUserTagQueryService {
