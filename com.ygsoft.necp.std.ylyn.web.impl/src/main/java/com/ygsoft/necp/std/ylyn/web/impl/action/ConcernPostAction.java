...
import com.ygsoft.necp.std.ylyn.web.service.action.IConcernPostAction;
 ...
 */
@Component
public class ConcernPostAction extends AbstractBusinessAction<ConcernPost> implements IConcernPostAction {
	
	/**
	 * ConcernPostAction constructor.
	 * @param newBo newBo.
	 */
	public ConcernPostAction(ConcernPost newBo) {
		super(newBo);
	}
