...
import com.ygsoft.necp.std.ylyn.web.service.action.IPostBrowseAction;
 ...
 */
@Component
public class PostBrowseAction extends AbstractBusinessAction<PostBrowse> implements IPostBrowseAction {
	
	/**
	 * PostBrowseAction constructor.
	 * @param newBo newBo.
	 */
	public PostBrowseAction(PostBrowse newBo) {
		super(newBo);
	}
