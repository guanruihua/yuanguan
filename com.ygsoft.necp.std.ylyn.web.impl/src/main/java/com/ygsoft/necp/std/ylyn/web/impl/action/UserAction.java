...
import com.ygsoft.necp.std.ylyn.web.service.action.IUserAction;
 ...
 */
@Component
public class UserAction extends AbstractBusinessAction<User> implements IUserAction {
	
	/**
	 * UserAction constructor.
	 * @param newBo newBo.
	 */
	public UserAction(User newBo) {
		super(newBo);
	}
