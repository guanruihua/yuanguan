...
/**
 * IPostMessageContext场景接口类.<br>
 *
 * @author 170202104078 <br>
 * @version 1.0.0 2020-06-18 14:50:26<br>
 * @since JDK 1.8.0_144
 */
public interface IPostMessageContext extends IGenEntityContext<PostMessage, String> {

	List<PostMessage> findByPostIDOrderByMessageNumAsc(String postId);

	Page<PostMessage> getPostMessageByPage(String postId,int index);
